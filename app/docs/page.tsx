    ...
    <main className="col" style={{ gap: 24 }}>
      ...
      <section id="encryption-modes" className="card col" style={{ gap: 16 }}>
        ...
        <ul className="muted" style={{ fontSize: 12, display: 'grid', gap: 4 }}>
          ...
          <li>
            Fully on-chain accountability: every send emits a burn event on the 3send manager
            contract.
          </li>
          <li>
            Time-boxed inboxes: 3send retains encrypted payloads for seven days before they are
            purged, keeping the network lean and minimizing data linger.
          </li>
        </ul>
      </section>
        ...
        <div className="col" style={{ gap: 12 }}>
          ...
          <div>
            ...
            <div className="muted" style={{ fontSize: 12, lineHeight: 1.5 }}>
              ...
              storage. 3send never transmits the phrase or private key. Write it down or stash it in
              a hardware vault so you can import it on other devices. Lose the phrase and the inbox
              is gone forever, and nobody else - including 3send - can unlock your archived files.
            </div>
          </div>
        </div>
        <div className="muted" style={{ fontSize: 12, lineHeight: 1.5 }}>
      ...
      <section id="encryption-pipeline" className="card col" style={{ gap: 16 }}>
        ...
        <ol className="muted" style={{ fontSize: 12, display: 'grid', gap: 8 }}>
          ...
          <li>
            ...
            the returned CID, while the envelope and payment proof land in <code>cstore</code>.
            After a seven-day retention window, files are purged from r1fs and cstore entries are
            pruned, removing the traces of the transfer.
          </li>
        </ol>
        <div className="muted" style={{ fontSize: 12, lineHeight: 1.5 }}>
